...
abstract class SplitText {
  List<String> getSplitText(Size pageSize, TextStyle textStyle, String text);
}

class SplitTextImpl extends SplitText {
  @override
  List<String> getSplitText(Size pageSize, TextStyle textStyle, String text) {
    final _height = pageSize.height - pageSize.height / 4.15;
    ...
    double currentPageBottom = _height;
